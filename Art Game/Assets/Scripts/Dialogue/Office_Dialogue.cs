...
public class Office_Dialogue : MonoBehaviour
{
    ...
    public List<Tuple<string,string, string>> pre_paintings(int whoDunIt)
    {
        ...
        response.Add(new Tuple<string,string,string>("Player","normal","Hey Professor, long time no see!"));
        ...
        response.Add(new Tuple<string, string, string>("Player", "norma", "I heard what happened to you. weirdest thing is it's not just you, happened to a friend of mine."));
        ...
        response.Add(new Tuple<string, string, string>("Player", "normal","Yeah for sure! But I can't do these for free, I've already lost money tonight."));
        return response;
    }
    ...
    {
        List<Tuple<string, string, string>> response = new List<Tuple<string, string, string>>();
        response.Add(new Tuple<string, string, string>("Player", "normal", "So where were you at? I thought you preferred catching up with work at night?"));
        response.Add(new Tuple<string, string, string>("Crane", "angry", "Oh I was at that art show Dr. Burch is hosting. I submitted some of my pieces but didn't find any of them hanging up. I talked to her and she claimed they weren't good enough! I come back here to take my mind off of things and this mess was here!"));
        response.Add(new Tuple<string, string, string>("Player", "normal", "<I> Yeah, because this is so much worse than the disorganized mess you usually have."));
        response.Add(new Tuple<string, string, string>("Player", "normal", "Weird, that's where my friend was as well..."));
        return response;
    }
    ...
    public List<Tuple<string, string, string>> second_painting_done(int whoDunIt)
    {
        ...
        response.Add(new Tuple<string, string, string>("Player", "normal", "What was that?"));
        response.Add(new Tuple<string, string, string>("Crane", "happy","Oh nothing, just saying that she got what she deserved."));
        response.Add(new Tuple<string, string, string>("Player", "normal", "Kristen? That's a bit harsh"));
        ...
        response.Add(new Tuple<string, string, string>("Player", "normal", "<I> What is going on!?"));
        response.Add(new Tuple<string, string, string>("Player", "normal", "Oh no! I'll go see if she can tell me anything about what happened."));
        return response; 
    }
